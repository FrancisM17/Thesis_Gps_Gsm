...
void send_Message() {
  ...
  updateSerial();
  gsmSerial.println("AT+CMGS=\"zzzzzzz\"");//change ZZ with country code and xxxxxxxxxxx with phone number to sms
  updateSerial();
  gsmSerial.print("An emergency situation occured I am at " + Coordinates + " please plot this at google maps"); //text content
  updateSerial();
  gsmSerial.write(26);
  delay(2000);
  gsmSerial.end();
